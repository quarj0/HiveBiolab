...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-d2=%&#x+wop@vq8z$chrd5=!p_@^6j(q*&p+h($w=+wx-a0v%c",
)
...
FRONTEND_ORIGINS_SETTING = os.environ.get(
...
CSRF_TRUSTED_ORIGINS = [
    origin
    for origin in os.environ.get("CSRF_TRUSTED_ORIGINS", FRONTEND_ORIGINS_SETTING).split()
    if origin
]
